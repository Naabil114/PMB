...
Route::middleware('guest')->group(function () {
    ...
    Route::get('/pendaftar/login', [PendaftarAuthController::class, 'formLogin'])->name('pendaftar.login.form');
    Route::post('/pendaftar/login', [PendaftarAuthController::class, 'login'])->name('pendaftar.login');

    Route::get('/pendaftar/register', [PendaftarAuthController::class, 'formRegister'])->name('pendaftar.register.form');
    Route::post('/pendaftar/register', [PendaftarAuthController::class, 'register'])->name('pendaftar.register');
});
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/pendaftaran/{id}/verifikasi',[VerifikasiDokumenController::class, 'formVerifikasi'])->name('pendaftaran.verifikasi');
    Route::post('/pendaftaran/{id}/verifikasi', [VerifikasiDokumenController::class, 'simpanVerifikasi'])->name('pendaftaran.verifikasi.simpan');
...
Route::middleware('auth:pendaftar')->group(function () {
    ...
    Route::get('/pendaftar/dashboard', fn() => view('pendaftar.dashboard'))->name('pendaftar.dashboard');

    Route::get('/mahasiswa/periode/index', [PeriodePendaftaranController::class, 'index'])->name('mahasiswa.periode.index');
    ...
    Route::get('/pendaftaran/{periode}/kartu', [KartuPendaftaranController::class, 'cetak'])->name('pendaftaran.kartu');
    Route::post('/pendaftar/logout', [PendaftarAuthController::class, 'logout'])->name('pendaftar.logout');


    Route::get('/pendaftar/verifikasi/dokumen', [VerifikasiDokumenController::class, 'dokumenPendaftar'])->name('pendaftar.verifikasi.index');


    Route::get('pendaftaran/{id}/upload-ulang', [VerifikasiDokumenController::class, 'formUploadUlang'])->name('pendaftaran.uploadUlang');
    Route::post('pendaftaran/{id}/upload-ulang', [VerifikasiDokumenController::class, 'prosesUploadUlang'])->name('pendaftaran.prosesUploadUlang');


    Route::get('/pendaftar/data', [PendaftaranController::class, 'dataPendaftar'])->name('pendaftar.data');
    

    Route::get('/cek-kelulusan', [CekKelulusanController::class, 'index'])->name('cek.kelulusan');
    Route::post('/cek-kelulusan', [CekKelulusanController::class, 'cek'])->name('cek.kelulusan.cek');
