<nav class="navbar navbar-expand-lg main-navbar">
    ...
    @php
        ...
        $pendaftar = Auth::guard('pendaftar')->check()
            ? Auth::guard('pendaftar')->user()
            : null;
    @endphp
    ...
    <ul class="navbar-nav navbar-right">
        <li class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                @elseif($pendaftar)
                    <a href="{{ route('pendaftar.logout') }}"
                       class="dropdown-item has-icon text-danger"
                       onclick="event.preventDefault(); document.getElementById('logout-pendaftar').submit();">
                        <i class="fas fa-sign-out-alt"></i> Logout
                    </a>

                    <form id="logout-pendaftar" action="{{ route('pendaftar.logout') }}" method="POST" style="display:none;">
                        @csrf
                    </form>
                @endif
